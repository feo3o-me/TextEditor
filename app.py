...
def font_selector(text_editor):
    ...
    select = tk.StringVar()
    font_box = ttk.Combobox(new_window, textvariable=select)
    font_box['values'] = (
    'Arial',
    'Courier New',
    'Calambria',
    ...
    send = tk.Button(new_window, text = "Ok", relief=tk.GROOVE, command = lambda: text_editor.configure(font="Courier New, 18"))
...
def main():
    ...
    text_editor = tk.Text(window, font="Arial 12", padx = 3)
